...
def main(targets):
    ...
    if targets[0] == 'all':
        ...
        if 'test' in targets:
            ...
            assoc.create_wgt_index(**{**data_config, 'vcf': 'test/testdata/test_genotypes.vcf', 'expressions': 'test/testdata/test_expressions.txt', 'populations': 'test/testdata/test_populations.txt', 'temp_loc': 'test/tmp', 'out_loc': 'test/out', 'gwas_sumstats': 'test/testdata/test_sumstats.txt', 'outfile': 'test','genelist': 'test/testdata/test_genelist.txt'})
